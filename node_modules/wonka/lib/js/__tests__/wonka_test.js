...
var CallbagIterate = require("callbag-iterate");
var CallbagFromObs = require("callbag-from-obs");
var CallbagFromIter = require("callbag-from-iter");

Jest.describe("source factories", (function (param) {
        Jest.describe("fromList", (function (param) {
                return Jest.test("sends list items to a puller sink", (function (param) {
                              ...
                              talkback[0](/* Pull */0);
                              talkback[0](/* Pull */0);
                              return Curry._2(Jest.Expect[/* Operators */25][/* = */5], Jest.Expect[/* expect */0](signals), /* array */[
                                          /* Push */Block.__(1, [10]),
                                          /* Push */Block.__(1, [20]),
                                          /* Push */Block.__(1, [30]),
                                          /* End */0
        ...
        Jest.describe("fromArray", (function (param) {
                Jest.test("sends array items to a puller sink", (function (param) {
                        ...
                        return Curry._2(Jest.Expect[/* Operators */25][/* = */5], Jest.Expect[/* expect */0](signals[0]), /* array */[
                                    /* Push */Block.__(1, [10]),
                                    /* Push */Block.__(1, [20]),
                                    /* Push */Block.__(1, [30]),
                                    /* End */0
                ...
                return Jest.test("does not blow up the stack when iterating something huge", (function (param) {
                              ...
                              return Curry._2(Jest.Expect[/* Operators */25][/* = */5], Jest.Expect[/* expect */0](values.length), arr.length);
                            }));
              }));
        Jest.describe("fromValue", (function (param) {
        ...
        Jest.describe("empty", (function (param) {
                return Jest.test("ends immediately", (function (param) {
                              ...
                              talkback[0](/* Pull */0);
                              talkback[0](/* Pull */0);
                              return Curry._2(Jest.Expect[/* Operators */25][/* = */5], Jest.Expect[/* expect */0](/* tuple */[
                                              _signals,
                                              signals
                                            ]), /* tuple */[
                                          /* array */[/* End */0],
        ...
        Jest.describe("never", (function (param) {
                return Jest.test("does not end", (function (param) {
                              ...
                              talkback[0](/* Pull */0);
                              talkback[0](/* Pull */0);
                              return Curry._2(Jest.Expect[/* Operators */25][/* == */0], Jest.Expect[/* expect */0](ended[0]), false);
                            }));
              }));
        Jest.describe("fromObservable", (function (param) {
                return Jest.testPromise("creates a source from an observable", undefined, (function (param) {
                              var observable = Wonka_thelpers.observableFromArray(/* array */[
                                    1,
                                    2
                                  ]);
                              return Wonka_thelpers.testSource(Wonka.fromObservable(observable)).then((function (x) {
        ...
        return Jest.describe("fromCallbag", (function (param) {
                      Jest.testPromise("creates a source from a callbag (observable)", undefined, (function (param) {
                              var observable = Wonka_thelpers.observableFromArray(/* array */[
                                    1,
                                    2
                                  ]);
                              var callbag = CallbagFromObs(observable);
                              return Wonka_thelpers.testSource(Wonka.fromCallbag(callbag)).then((function (x) {
                                            return Promise.resolve(Jest.Expect[/* toEqual */12](/* array */[
                                                            /* Push */Block.__(1, [1]),
                                                            /* Push */Block.__(1, [2]),
                                                            /* End */0
                      ...
                      return Jest.testPromise("creates a source from a callbag (iterable)", undefined, (function (param) {
                                    var callbag = CallbagFromIter(/* array */[
                                          1,
                                          2
                                        ]);
                                    return Wonka_thelpers.testSource(Wonka.fromCallbag(callbag)).then((function (x) {
...
Jest.describe("operator factories", (function (param) {
        ...
        Jest.describe("sample", (function (param) {
                afterEach((function () {
                        jest.useRealTimers();
                        return /* () */0;
                      }));
                Jest.test("should sample the last emitted value from a source", (function (param) {
                        ...
                        var signals = /* array */[];
                        var source = Wonka.sample(Wonka.interval(100))(a);
                        Curry._1(source, (function (signal) {
                                if (typeof signal === "number") {
                                  signals.push(signal);
                                  return /* () */0;
                ...
                return Jest.test("should emit an End signal when the source has emitted all values", (function (param) {
                              ...
                              var signals = /* array */[];
                              var source = Wonka.take(3)(Wonka.sample(Wonka.interval(100))(a));
                              Curry._1(source, (function (signal) {
                                      if (typeof signal === "number") {
                                        signals.push(signal);
                                        return /* () */0;
        ...
        Jest.describe("scan", (function (param) {
        ...
        Jest.describe("share", (function (param) {
        ...
        Jest.describe("combine", (function (param) {
        ...
        Jest.describe("takeLast", (function (param) {
        ...
        Jest.describe("takeUntil", (function (param) {
                Jest.test("only lets the last n values through on an entirely new source", (function (param) {
                        var talkback = /* record */[/* contents */(function (param) {
                              return /* () */0;
                            })];
        ...
        Jest.describe("skip", (function (param) {
        ...
        Jest.describe("skipWhile", (function (param) {
        ...
        Jest.describe("skipUntil", (function (param) {
        ...
        Jest.describe("switchMap", (function (param) {
                afterEach((function () {
                        jest.useRealTimers();
                        return /* () */0;
                      }));
        ...
        return Jest.describe("buffer", (function (param) {
                      beforeEach((function () {
                              jest.useFakeTimers();
                              return /* () */0;
                            }));
                      ...
                      Jest.test("should buffer values and emit them on each notifier tick", (function (param) {
                              var a = Wonka.interval(50);
                              var talkback = /* record */[/* contents */(function (param) {
                                    return /* () */0;
                                  })];
                              var signals = /* array */[];
                              var source = Wonka.take(2)(Wonka.buffer(Wonka.interval(100))(a));
                              Curry._1(source, (function (signal) {
                                      if (typeof signal === "number") {
                                        signals.push(signal);
                                        return /* () */0;
                      ...
                      return Jest.test("should end when the notifier ends", (function (param) {
                                    var a = Wonka.take(3)(Wonka.interval(50));
                                    var talkback = /* record */[/* contents */(function (param) {
                                          return /* () */0;
                                        })];
                                    var signals = /* array */[];
                                    var source = Wonka.buffer(Wonka.interval(100))(a);
                                    Curry._1(source, (function (signal) {
                                            if (typeof signal === "number") {
                                              signals.push(signal);
                                              return /* () */0;
...
Jest.describe("sink factories", (function (param) {
        ...
        Jest.describe("subscribe", (function (param) {
        ...
        Jest.describe("toObservable", (function (param) {
                return Jest.testPromise("should convert a source to an Observable", undefined, (function (param) {
                              var source = Wonka.fromArray(/* array */[
                                    1,
                                    2
                                  ]);
                              var observable = Wonka_thelpers.observableFrom(Wonka.toObservable(source));
                              var values = /* array */[];
                              var promise = observable.forEach((function (value) {
                                      values.push(value);
                                      return /* () */0;
                                    }));
                              return promise.then((function (param) {
                                            return Promise.resolve(Jest.Expect[/* toEqual */12](/* array */[
                                                            1,
                                                            2
                                                          ], Jest.Expect[/* expect */0](values)));
                                          }));
                            }));
              }));
        Jest.describe("toCallbag", (function (param) {
                return Jest.test("should convert a source to a Callbag", (function (param) {
                              var source = Wonka.fromArray(/* array */[
                                    1,
                                    2
                                  ]);
                              var callbag = Wonka.toCallbag(source);
                              var values = /* array */[];
                              CallbagIterate((function (value) {
                                        values.push(value);
                                        return /* () */0;
                                      }))(callbag);
                              return Jest.Expect[/* toEqual */12](/* array */[
        ...
        return Jest.describe("toArray", (function (param) {
                      Jest.test("converts iterable sources to arrays", (function (param) {
                              var input = /* array */[
                                1,
                                2,
                                3
                              ];
                              var output = Wonka.toArray(Wonka.fromArray(input));
                              return Jest.Expect[/* toEqual */12](input, Jest.Expect[/* expect */0](output));
                            }));
                      Jest.test("converts mapped iterable sources to arrays", (function (param) {
                              var input = /* array */[
                                1,
                                2,
                                3
                              ];
                              var output = Wonka.toArray(Wonka.map((function (x) {
                                            return x;
                                          }))(Wonka.fromArray(input)));
                              return Jest.Expect[/* toEqual */12](input, Jest.Expect[/* expect */0](output));
                            }));
                      Jest.test("converts concatenated iterable sources to arrays", (function (param) {
                              var inputA = /* array */[
                                1,
                                2,
                                3
                              ...
                              var input = $$Array.append(inputA, inputB);
                              var output = Wonka.toArray(Wonka.concat(/* array */[
                                        Wonka.fromArray(inputA),
                                        Wonka.fromArray(inputB)
                                      ]));
                              return Jest.Expect[/* toEqual */12](input, Jest.Expect[/* expect */0](output));
                            }));
                      return Jest.test("ignores and closes asynchronous push streams", (function (param) {
                                    var input = /* array */[
                                      1,
                                      2,
                                      3
                                    ...
                                    var match = Wonka_thelpers.testSourceOperator(source);
                                    Wonka.toArray(match[1]);
                                    return Jest.Expect[/* toEqual */12](/* array */[
                                                /* Pull */0,
                                                /* Close */1
...
Jest.describe("chains (integration)", (function (param) {
...
Jest.describe("subject", (function (param) {
...
Jest.describe("web operators", (function (param) {
        ...
        Jest.describe("throttle", (function (param) {
                ...
                Jest.test("should not emit values before specified throttle (but include values on leading edge)", (function (param) {
                        ...
                        jest.runTimersToTime(400);
                        return Curry._2(Jest.Expect[/* Operators */25][/* = */5], Jest.Expect[/* expect */0](signals), /* array */[/* Push */Block.__(1, [0])]);
                      }));
        ...
        return Jest.describe("toPromise", (function (param) {
                      Jest.testPromise("should convert a source to a Promise", undefined, (function (param) {
                              var a = Wonka.fromValue(1);
                              return WonkaJs.toPromise(a).then((function (x) {
                                            return Promise.resolve(Jest.Expect[/* toEqual */12](1, Jest.Expect[/* expect */0](x)));
                                          }));
                            }));
                      return Jest.testPromise("should resolve only the last emitted value from a source", undefined, (function (param) {
                                    var a = Wonka.fromList(/* :: */[
                                          1,
                                          /* :: */[
                                            2,
                                    ...
                                    return WonkaJs.toPromise(a).then((function (x) {
                                                  return Promise.resolve(Jest.Expect[/* toEqual */12](3, Jest.Expect[/* expect */0](x)));
                                                }));
                                  }));
                    }));
      }));
